        ...
        >
          { work.hrefTo && (
            <a
              href={work.hrefTo}
              target="_blank" 
              className="bg-yellow-500 hover:bg-yellow-600 duration-200 p-2 rounded-full cursor-pointer" rel="noreferrer"
            >
          ...
          {
            <button className="bg-yellow-500 hover:bg-yellow-600 duration-200 p-2 rounded-full cursor-pointer">
